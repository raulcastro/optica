...
<head>
    ...
    <meta name="description" content="Venta en linea de los mejores lentes de contacto en playa del camen">
    <meta name="keywords" content="Lentes de contacto, Playa del carmen">
    ...
    <script type="application/ld+json">
{
  ...
  "@type": "Organization",
  "url": "https://www.clara-vision.com",
  "name": "Clara Vision Playa del carmen",
  "contactPoint": {
    "@type": "ContactPoint",
    "telephone": "984 125 7427",
        ...
        <div class="container">
            ...
            <div class="box1 clearfix">
                <ul class="follow_icon">
                    <li>
                        <a href="index-4.html#" class="fa fa-facebook"></a>
                    </li>
                    <li>
                        <a href="index-4.html#" class="fa fa-twitter"></a>
                    </li>

                </ul>
                <div class="box2 clearfix">
                    <p>Necesitas ayuda, llamanos<br><span>984 125 7427</span></p>
                </div>
            </div>
        </div>
        <nav id="stuck_container" class="navbar navbar-default navbar-static-top tm_navbar clearfix" role="navigation">
            <div class="container">
                <ul class="nav sf-menu clearfix">
                    ...
                    <ul class="submenu">
        				<li><a href="index-4.html#">history</a></li>
        				<li><a href="index-4.html#">news</a><span class="fa fa-angle-right"></span>
                            <ul class="submenu">
                                <li><a href="index-4.html#">latest</a></li>
                                <li><a href="index-4.html#">archive</a></li>
                              </ul> 
                        </li>
                    ...
                    <li><a href="catalogo.html"><b>Lentes de contacto</b></a></li>
                    <li class="active"><a href="contacto.html"><b>Contactanos</b></a></li>
                </ul>
                ...
                <a href="index-4.html#" onClick="document.getElementById('search').submit()"><img src="img/magnify.png" alt=""></a>
            </form>-->
            </div>
        </nav>
    </header>
                        ...
                        <form id="contact-form">
                            ...
                            <fieldset>
                              ...
                              <span class="error-message">*The message is too short.</span>
                                ...
                                <div class="btns">
                                    <a href="index-4.html#" data-type="submit" class="btn-default btn3">Enviar</a>
                                </div>
                            </fieldset>
