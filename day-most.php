        ...
        <div class="col-main">
          <div class="product-view-area">
            <div class="product-big-image col-xs-12 col-sm-5 col-lg-5 col-md-5">
              ...
              <div class="large-image"> <a href="img/DAY1.jpg" class="cloud-zoom" id="zoom1" rel="useWrapper: false, adjustY:0, adjustX:20"> <img class="zoom-img" src="img/DAY1.jpg" alt="products"> </a> </div>
            ...
            <div class="col-xs-12 col-sm-7 col-lg-7 col-md-7 product-details-area">
              ...
              <div class="short-description">
                <p>Laboratorio: Johnson & Johnson<br>
                    ...
                    Material: Etafilcon A<br>
                    Contenido del embalaje: 30 lentes<br>
                    Protección contra los rayos UV: Sí<br>
                    Tiempo de uso: Uso diario.<br>
                    Contenido de agua: 58%<br><br>
                    
                                                                                  
                    • Con el propósito de garantizar que los ojos sensibles y la sequedad ocular no son preocupación <br>
